...
sys.stdout.flush()
readTrainData("C:\\Users\\greenjoa\\PycharmProjects\\StudyAI-Seminar\\data\\train")
...
def readTrainCsv():
    raw_df = pd.read_csv('C:\\Users\\greenjoa\\PycharmProjects\\StudyAI-Seminar\\data\\train\\trainLabels.csv', sep=',')
